<template>
    <div>
        ...
        <div class="flex flex-col md:flex-row md:max-h-90vh mt-12">
            <div
                ...
                <ul class="px-2 py-4 max-w-lg">
                    ...
                    >
                        <div
                            ...
                            class="hover:bg-gray-200 cursor-pointer p-4 border my-2 border-gray-200"
                        >
                            {{ item.label }}
                        </div>
...
export default {
    setup(props) {
        ...
        const selectSurveyItem = (item) => {
            ...
            if (nextSurveyItems()) {
                Inertia.get(`/${usePage().props.value.prefix}/requests/step/6`);
            } else {
